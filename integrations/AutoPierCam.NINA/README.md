...
Build a release archive and SHA-256 N.I.N.A. manifest:
    ...
    ./build-nina-package.ps1 -Version 0.2.6.0

The default download URL uses the matching three-part product release tag
(`v0.2.6` in this example) while the plugin archive and manifest retain the
four-part N.I.N.A. version. Pass `-ReleaseTag v0.2.6-preview.1` when packaging
