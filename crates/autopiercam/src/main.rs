...
fn list_cameras(sdk: &Arc<Sdk>, as_json: bool) -> Result<()> {
...
fn probe_camera(sdk: &Arc<Sdk>, camera_id: Option<i32>) -> Result<()> {
...
fn run_agent(sdk: &Arc<Sdk>, config_path: &Path, max_frames: Option<u64>) -> Result<()> {
